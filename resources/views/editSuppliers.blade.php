	           ...
	           <div class="col-md-2"></div>
                <div class="col-md-8 ">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">Update Supplier's Information</h3></div>
                        @if ($errors->any())
                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ url('/updateSuppliers/'.$edit->id) }}" method="post" enctype="multipart/form-data">
                            	@csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="account_no" value="{{$edit->account_no}}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="" class="form-control" value="{{$edit->type}}">
                                        <option disabled="" selected="">supplier type</option>
                                        <option value="1">Distributor</option>
                                        <option value="2">Whole Seller</option>
                                        <option value="3">Brochure</option>
                                    </select>
                                        {{-- <input type="text" class="form-control" name="type" value="{{($edit->type)}}" required> --}}
                                    </div>
                                <div class="form-group">
                                	<img id="image" src="#" />
                                    <label for="exampleInputPassword11">New Image</label>
                                    <input type="file"  name="image" accept="image/*"  onchange="readURL(this);">
                                </div>

                                <div class="form-group">
                                    <img  src="{{URL::to($edit->image)}}"
