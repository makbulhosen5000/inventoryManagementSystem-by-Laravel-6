                    ...
                    <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title text-danger">View Attendance:<a href="{{ route('allAttendance') }}"
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered ">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" value="Present" disabled name="attendance[{{($row->id)}}]"
                                                            <?php
                                                            ...
                                                            ?>
                                                             >Present
                                                            <input type="radio" value="Absence" disabled name="attendance[{{($row->id)}}]"
                                                            <?php
