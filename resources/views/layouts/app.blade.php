...
<head>
    ...
    {{-- Script src --}}
    <script src="https://kit.fontawesome.com/3e8e05970c.js" crossorigin="anonymous"></script>
    <!-- CSRF Token -->
    ...
    {{-- sweetalert --}}
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert">
    <!-- Fonts -->
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="#" class="logo"><i class="md md-terrain"></i> <span>CodingDuck </span></a>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                           ...
                                           <a href="javascript:void(0);" class="list-group-item">
                                              <div class="media">
                                                 ...
                                                 <div class="media-body clearfix">
                                                    ...
                                                    <p class="m-0">
                                                       <small>You have 0 unread messages</small>
                                                    </p>
                                                 </div>
                                              </div>
                                           </a>
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{URL::to('admin/images/akash.jpg')}}" alt="user-img" class="img-circle"> </a>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{route('pos')}} " class="waves-effect active"><i class="md md-home text-info"></i><span><b class="text-info">POS</b></span></a>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{route('addEmployees')}} ">Add Employees</a></li>
                            ...
                            <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="{{route('addCustomers')}} ">Add Customers</a></li>
                                        <li><a href="{{route('allCustomers')}} ">All Customers</a></li>
                                    </ul>
                                    <a href="#" class="waves-effect"><i class="md md-palette"></i><span> Suppliers </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="{{route('addSuppliers')}} ">Add Suppliers</a></li>
                                        <li><a href="{{route('allSuppliers')}} ">All Suppliers</a></li>
                                    </ul>
                                    <a href="#" class="waves-effect"><i class="md md-palette"></i><span> Sarary(Employeer) </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="{{route('add_advanced_Salaries')}} ">Add Advance Salary</a></li>
                                        <li><a href="{{route('all_advanced_Salaries')}} ">All Advance Salary</a></li>
                                        <li><a href="{{route('pay_salary')}} ">Pay Sallary</a></li>
                                    ...
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li><a href="{{route('importProducts')}}">Import Products</a></li>
                                    ...
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="{{route('addExpense')}}">Add Expenses</a></li>
                                            <li><a href="{{route('todayExpense')}}">Today Expenses</a></li>
                                    ...
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li><a href="{{url('successOrders')}} ">Success Orders</a></li>
                                        </ul>
                                    </li>
                                    <li class="has_sub">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><a href="{{route('home')}} ">Seles Report</a></li>
