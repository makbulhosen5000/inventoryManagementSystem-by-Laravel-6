	           ...
	           <div class="col-md-2"></div>
                <div class="col-md-8 ">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">Update Employee's Information</h3></div>
                        @if ($errors->any())
                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ url('/updateEmployees/'.$edit->id) }}" method="post" enctype="multipart/form-data">
                            	@csrf
